...
| [`preset-app-decorators`](/packages/preset-app-decorators) | [![npm](https://img.shields.io/npm/v/preset-app-decorators.svg?maxAge=2592000)](https://www.npmjs.com/package/preset-app-decorators) | [![Dependency Status](https://david-dm.org/SerkanSipahi/app-decorators.svg?path=packages/preset-app-decorators)](https://david-dm.org/SerkanSipahi/app-decorators?path=packages/preset-app-decorators) | [![DevDependency Status](https://david-dm.org/SerkanSipahi/app-decorators.svg?path=packages/preset-app-decorators&type=dev)](https://david-dm.org/SerkanSipahi/app-decorators?path=packages/preset-app-decorators&type=dev) |
---
##### Quickstart: 
